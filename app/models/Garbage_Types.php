<?php
  class Garbage_Types{
    ...
    public function update_garbage_types($data){
      $this->db->query('UPDATE garbage_types SET name= :garbage_type, credits_per_waste_quantity = :credits, approxiamte_amount= :approximate_amount, minimum_amount=:minimum_amount, selling_price=:selling_price');
