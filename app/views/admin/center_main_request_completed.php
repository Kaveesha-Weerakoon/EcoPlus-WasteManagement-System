                            ...
                            <?php foreach($data['completed_requests'] as $completed_request) : ?>
                                <tr class="table-row">
                                    ...
                                    <td class="cancel-open">
                                        <img class="collector_img" src="<?php echo IMGROOT?>/img_upload/collector/<?php echo $completed_request->collector_image?>"
                                    ...
                                    <td class="cancel-open">
                                            ...
                                            onclick="view_collect_details(<?php echo htmlspecialchars(json_encode($completed_request), ENT_QUOTES, 'UTF-8') ?>)"
                                            ></i>
                                    </td>
