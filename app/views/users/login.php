        ...
        <div class="forms-container">
          ...
          <form action="<?php echo URLROOT; ?>/users/login" class="sign-in-form" method="POST">
              ...
              <div class="input-fieldlog">
                ...
                <input type="text" class="text" placeholder="Email" id="" class="<?php echo (!empty($data['email_err'])) ? 'alert_empty' : ''; ?>" value="<?php echo $data['email']; ?>">
              </div>
              <div class="field-two">
              ...
              <div class="input-fieldlog">
                ...
                <input type="password" class="text" placeholder="Password" id="" class="<?php echo (!empty($data['password_err'])) ? 'alert_empty' : ''; ?>" value="<?php echo $data['password']; ?>">
              </div>
              <div class="field-two">
            ...
            <div class="cont-main">
              <div class="cont">
                ...
                <div class="input-field">
                  <input type="text" class="text" placeholder="name" value="<?php echo $data['name']; ?>" name="name" id="name">
                </div>
              </div>
                <div class="cont">
                  <p>Email</p>
                  <div class="input-field2">
                    <input type="text" class="text" placeholder="Email" value="<?php echo $data['email']; ?>" name="email" id="email">
                  </div>
                </div>
            ...
            <div class="cont-main">
              <div class="cont">
                <p>Contact No</p>
                <div class="input-field">
                  <input type="text" class="text" placeholder="contact no"  value="<?php echo $data['contact_no']; ?>" name="contact_no" id="contact_no">
                </div>
              </div>
              ...
              <div class="cont">
                <p>Address</p>
                <div class="input-field2">
                  <input type="text" class="text" placeholder="address" value="<?php echo $data['address']; ?>"
            ...
            <div class="cont-main">
              ...
              <p>Password</p>
                <div class="input-field">
                  <input type="text" class="text" placeholder="Password" id="password"
