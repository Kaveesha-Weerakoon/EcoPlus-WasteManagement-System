<?php
  class Collector_Complain {
    ...
    public function complains($data){
        ...
        $this->db->query('INSERT INTO collector_complains (collector_id,name,contact_no, region,subject,complaint) VALUES (:collector_id,:name,:contact_no,:region,:subject,:complaint)');
        // Bind values
